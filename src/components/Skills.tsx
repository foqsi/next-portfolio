...
import { SiNextdotjs, SiTailwindcss, SiJavascript, SiTypescript, SiSupabase, SiSailsdotjs, SiFramer } from 'react-icons/si'
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
        <FadeSequence
          steps={skills.map((skill) => (
            <div
              key={skill.name}
              className="flex flex-col items-center p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm transition hover:scale-105"
            >
